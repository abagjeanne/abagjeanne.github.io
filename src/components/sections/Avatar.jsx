import { alexAvatar } from "@/assets/images";
    ...
    <div className="lg:sticky relative top-8 bg-[#ebf0f6] dark:bg-[#161616]  lg:h-[calc(100vh-64px)] h-auto p-8 border border-box rounded-[40px] flex flex-col justify-between lg:gap-0 gap-4">
      <div className="">
        <div className="flex gap-5 2xl:mb-5 mb-[10px]">
          ...
          <p className="2xl:text-4xl text-[28px] font-bold text-bright leading-8">
            Alex <br /> Walker
          </p>
        </div>
        <div className="rounded-3xl overflow-hidden">
          <img className="w-full" src={alexAvatar} alt="" />
        </div>
      </div>
      <div className="">
      ...
      <div className="">
        <SocialIcons />
        <Button href={"#contact"} className="2xl:h-[60px] h-[50px] bg-btn text-btn">Let's Work Together!</Button>
      </div>
    </div>
  );
};
